package com.app.lightnovelreader.ui.author.viewmodel;
...
public class NovelAuthorViewModel extends ViewModel {
    ...
    public void getNovels(String author) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        CollectionReference novelsRef = db.collection("Novel");
        Query query = novelsRef.whereEqualTo("author", author);
